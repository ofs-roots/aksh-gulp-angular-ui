          										...
          										"separator_after": false,
           										...
           										"action": function (obj) { 
           											...
           											$scope.$apply(function(){
           												...
           												$scope.hostgroup.hostbaseline="";
           												$scope.hostgroup.suppress_excluded_service="";
           												$scope.hostgroup.send_to_cta="";
           												$scope.hostgroup.host_trap="";
           												$scope.hostgroup.inverse_suppression="";
